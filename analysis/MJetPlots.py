...
inputDir        = '/eos/user/n/nipinto/FCCAnalyses_MELA/analysis/FCCAnalysisOut/July30Set1'
formats         = ['pdf', 'png']
#outdir          = f'plots_{flavor}/'
outdir          = 'jetPlots/NHCBTest1'
plotStatUnc     = False
...
# procs['signal'] =   {'ZH_0+':[f'wzp6_ee_ccH_Hbb_ecm240',
...
hists["chi_nmone_NHCB"] = {
    "output":   "chi_nmone_NHCB",
    "logy":     False,
    "stack":    False,
    "rebin":    20,
    "xmin":     0,
