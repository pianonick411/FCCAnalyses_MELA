...
# 'p8_ee_ZZ_ecm240': {'fraction':1, 'chunks':1500},
...
f'wzp6_ee_qqH_ecm240': {'fraction':1, 'chunks':1500},



f'wzp6_ee_bbH_Hbb_ecm240': {'fraction':1, 'chunks':1500},
f'wzp6_ee_bbH_Hcc_ecm240': {'fraction':1, 'chunks':1500},
 f'wzp6_ee_bbH_Hss_ecm240': {'fraction':1, 'chunks':1500},
    f'wzp6_ee_bbH_Hgg_ecm240': {'fraction':1, 'chunks':1500},
     'wzp6_ee_bbH_Htautau_ecm240':{'fraction':1},
 'wzp6_ee_bbH_HZZ_ecm240':{'fraction':1, 'chunks':1500},
 'wzp6_ee_bbH_HWW_ecm240':{'fraction':1, 'chunks':1500},



   f'wzp6_ee_ccH_Hbb_ecm240': {'fraction':1, 'chunks':1500},
    f'wzp6_ee_ccH_Hcc_ecm240': {'fraction':1, 'chunks':1500},
    f'wzp6_ee_ccH_Hss_ecm240': {'fraction':1, 'chunks':1500},
    f'wzp6_ee_ccH_Hgg_ecm240': {'fraction':1, 'chunks':1500},
   'wzp6_ee_ccH_Htautau_ecm240':{'fraction':1, 'chunks':1500},
   'wzp6_ee_ccH_HZZ_ecm240':{'fraction':1, 'chunks':1500},
   'wzp6_ee_ccH_HWW_ecm240':{'fraction':1, 'chunks':1500},

    f'wzp6_ee_ssH_Hbb_ecm240': {'fraction':1,'chunks':1500},
    f'wzp6_ee_ssH_Hcc_ecm240': {'fraction':1, 'chunks':1500},
    f'wzp6_ee_ssH_Hss_ecm240': {'fraction':1, 'chunks':1500},
    f'wzp6_ee_ssH_Hgg_ecm240': {'fraction':1, 'chunks':1500},
    'wzp6_ee_ssH_Htautau_ecm240':{'fraction':1, 'chunks':1500},
   'wzp6_ee_ssH_HZZ_ecm240':{'fraction':1, 'chunks':1500},
   'wzp6_ee_ssH_HWW_ecm240':{'fraction':1, 'chunks':1500},
...
#Dhruv: Set this to whatever you want. 
outputDir   = ""
...
# extracting jet variables - grafted from loukas' scripts - THIS WHOLE FUNCTION IS NEW/NEEDED! CAN PICK AND CHOOSE VARIABLES. I PERFORM ALL JET MATH AND SUCH HERE  
    ...
    def analysers(df):
        ...
        #        df = (df.Define("jet{}_scoreU{}".format(x,anatag), "recojet_isU{}[{}]".format(anatag, x)))
                ...
                df = df.Define("jet{}_ScoreVec".format(x), "FCCAnalyses::JHUfunctions::MakeScoreVector(jet{}_scoreQ, jet{}_scoreB, jet{}_scoreC, jet{}_scoreS, jet{}_scoreG, jet{}_scoreTAU)".format(x,x,x,x,x,x))
